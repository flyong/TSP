...
def test():
    ...
    data_path, result_path, correlation_path, position_path = ex.getFilePathList()
...
def plotNetwork(figureIndex, relation_sheet):
    """
    ...
    """
    testIter = 1
    dat_path_path, result_path, correlation_path, position_path = ex.getFilePathList()
